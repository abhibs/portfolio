                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('skill-store') }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="4" cols="50">
                                            </textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" class="btn btn-primary px-4" value="Add Skill" />
                                        </div>
                                    </div>
                            </div>
