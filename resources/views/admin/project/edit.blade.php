...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Admin Project</div>
            <div class="ps-3">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('project-update') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="name"
                                                ...
                                                placeholder="Enter Name of The Project" value="{{ $data->name }}"/>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Project Created Date</h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                            <input type="date" class="form-control @error('url') is-invalid @enderror"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" class="btn btn-primary px-4" value="Update Project" />
                                        </div>
                                    </div>
                            </div>
